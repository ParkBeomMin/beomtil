...
describe('표기법 변환 함수 object', () => {
    it('object, camel to camel', () => {
        const result = changeValueNotation({ notaionTest1: 1, notaionTest2: 2, notaionTest3: 3 }, 'camel');
    ...
    it('object, snake to camel', () => {
        const result = changeValueNotation({ notaionTest1: 1, notaion_test2: 2, notaion_test3: 3 }, 'camel');
        assert.deepEqual(result, {
            notaionTest1: 1,
            notaionTest2: 2,
            notaionTest3: 3,
    ...
    it('object, pascal to camel', () => {
        const result = changeValueNotation({ NotaionTest1: 1, NotaionTest2: 2, notaion_test3: 3 }, 'camel');
        assert.deepEqual(result, {
            notaionTest1: 1,
            notaionTest2: 2,
            notaionTest3: 3,
    ...
    it('object, camel to pascal', () => {
        const result = changeValueNotation({ notaionTest1: 1, notaionTest2: 2, notaionTest3: 3 }, 'pascal');
        assert.deepEqual(result, {
            NotaionTest1: 1,
            NotaionTest2: 2,
            NotaionTest3: 3,
    ...
    it('object, snake to pascal', () => {
        const result = changeValueNotation({ notaionTest1: 1, notaion_test2: 2, notaion_test3: 3 }, 'pascal');
        assert.deepEqual(result, {
            NotaionTest1: 1,
            NotaionTest2: 2,
            NotaionTest3: 3,
    ...
    it('object, pascal to pascal', () => {
        const result = changeValueNotation({ NotaionTest1: 1, NotaionTest2: 2, notaion_test3: 3 }, 'pascal');
        assert.deepEqual(result, {
            NotaionTest1: 1,
            NotaionTest2: 2,
            NotaionTest3: 3,
    ...
    it('object, camel to snake', () => {
        const result = changeValueNotation({ notaionTest1: 1, notaionTest2: 2, notaionTest3: 3 }, 'snake');
        assert.deepEqual(result, {
            notaion_test1: 1,
            notaion_test2: 2,
            notaion_test3: 3,
    ...
    it('object, snake to snake', () => {
        const result = changeValueNotation({ notaionTest1: 1, notaion_test2: 2, notaion_test3: 3 }, 'snake');
        assert.deepEqual(result, {
            notaion_test1: 1,
            notaion_test2: 2,
            notaion_test3: 3,
    ...
    it('object, pascal to snake', () => {
        const result = changeValueNotation({ NotaionTest1: 1, NotaionTest2: 2, notaion_test3: 3 }, 'snake');
        assert.deepEqual(result, {
            notaion_test1: 1,
            notaion_test2: 2,
            notaion_test3: 3,
